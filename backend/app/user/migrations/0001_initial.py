    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(default='', max_length=10, null=True, verbose_name='별칭')),
                ('email', models.EmailField(max_length=254, unique=True, verbose_name='이메일')),
                ('real_email', models.EmailField(max_length=254, null=True, verbose_name='실제이메일')),
                ...
                ('is_register', models.BooleanField(default=False, verbose_name='등록여부')),
